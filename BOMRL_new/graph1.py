...
ax = plt.gca()
plt.plot(axis,data_cheetah_1,'-', linewidth=2.0 ,label="BO-MRL with $\mathcal{A l g}^{(1)}$")
plt.plot(axis,data_cheetah_2,'--', linewidth=2.0 ,label="BO-MRL with $\mathcal{A l g}^{(2)}$")
